        ...
        {activePage === "settingsClientsEdit" && selectedClient && (
          <Card className={`rounded-3xl ${theme.border} bg-white shadow-sm`}>
            <CardContent className="space-y-4 p-4">
              ...
              <SelectInput label="Select client" value={String(selectedClientId)} onChange={(value) => setSelectedClientId(value)} options={clients.map((client) => ({ label: client.name, value: String(client.id) }))} />
